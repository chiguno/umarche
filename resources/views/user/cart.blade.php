                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    @if (count($products) > 0)
                        ...
                        <div class="my-2"> 
                           ...
                           <div> 
                            <button onclick="location.href='{{ route('user.cart.checkout')}}'" class="flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">購入する 
                            </button> 
                        </div>
                    @else
                        カートに商品が入っていません。
